    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: [
              Image(image: const AssetImage(TImages.verificationMailSent), width: THelperFunctions.screenWidth() * 0.6),
              ...
              SizedBox(
                width: double.infinity,
                child:  SizedBox(width: double.infinity, child: TextButton(onPressed: () => ForgetPasswordController.instance.resendPasswordResetEmail(email) , child: const Text(TTexts.resendEmail))),
              ),
